...
public class STSNature {
  public static LinkedPage open() {
    ...
    CobbleSTS.config.getNature().forEach((key, value) -> {
      buttons.add(GooeyButton.builder()
        .display(Utils.parseItemId(CobbleSTS.language.getItemNature().getId()))
        .title(AdventureTranslator.toNative(CobbleSTS.language.getColorhexItem() + CobbleSTS.language.getNature().getOrDefault(key, key) + CobbleSTS.language.getColorSeparator() +
    ...
    LinkedPage.Builder linkedPageBuilder = LinkedPage.builder()
      .title(CobbleSTS.language.getTitleNature());
