    ...
    CobbleSTS.config.getNature().forEach((key, value) -> {
      buttons.add(GooeyButton.builder()
        ...
        .with(DataComponentTypes.ITEM_NAME,
          AdventureTranslator.toNative(CobbleSTS.language.getColorhexItem() + CobbleSTS.language.getNature().getOrDefault(key, key) + CobbleSTS.language.getColorSeparator() +
