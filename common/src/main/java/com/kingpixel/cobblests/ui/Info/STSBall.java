  ...
  public static LinkedPage open() {
    ...
    CobbleSTS.config.getBall().forEach((key, value) -> {
      buttons.add(GooeyButton.builder()
        ...
        .title(AdventureTranslator.toNative(CobbleSTS.language.getColorhexItem() + CobbleSTS.language.getBall().getOrDefault(key, key) + CobbleSTS.language.getColorSeparator() +
